    ...
    <script>
        ...
        function validateForm() {
            try {
                ...
                var trimSizeWidth = document.authorForm.trimSizeWidth.value;
                var trimSizeHeight = document.authorForm.trimSizeHeight.value;
                ...
                var paperWeightErr = coverTypeErr = priceBarcodeErr = trimSizeWidthErr = trimSizeHeightErr = dimenSpecificationErr = artImageErr = authorImageErr /*= visionDesignErr*/ = fileErr/*=coverImageIdErr*/ = true;
                ...
                // Validate trimSize Width
                if (trimSizeWidth == "") {
                    printError("trimSizeWidthErr", "Please enter trim size width.");
                } else {
                    printError("trimSizeWidthErr", "");
                    trimSizeWidthErr = false;
                }

                // Validate trimSize Height
                if (trimSizeHeight == "") {
                    printError("trimSizeHeightErr", "Please enter trim size height.");
                } else {
                    printError("trimSizeHeightErr", "");
                    trimSizeHeightErr = false;
                }
                ...
                if ((paperWeightErr || coverTypeErr || priceBarcodeErr || trimSizeWidthErr || trimSizeHeightErr || dimenSpecificationErr || artImageErr || authorImageErr /*|| visionDesignErr*/ || fileErr/*||coverImageIdErr*/) == true) {
                    ...
                    console.log("trimSizeWidthErr:" + trimSizeWidthErr);
                    console.log("trimSizeHeightErr:" + trimSizeWidthErr);
...
<body>
    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-lg-6">
                <h3 class="text-center p-2 heading">COVER DESIGN</h3>
            </div>
            ...
            <form name="authorForm" onsubmit="return validateForm()"
                ...
                <div class="row">
                    <div class="col-md-6 mt-md-0 mt-3">
                        ...
                        <input type="number" name="trimSizeWidth" id="trimSizeWidth" class="form-control" value="<?php if ((!empty($result['trimSizeWidth']))) {
                            echo $result['trimSizeWidth'];
                        } ?>" required <?php if ((!empty($result['trimSizeWidth']))) {
                             echo 'readonly="readonly"';
                         } ?>>
                        <div class="text-danger" id="trimSizeWidthErr"></div>

                    </div>
                    <div class="col-md-6 mt-md-0 mt-3">
                        <label>Trim size height in inches<span class="text-danger">*</span></label>
                        <input type="number" name="trimSizeHeight" class="form-control" value="<?php if ((!empty($result['trimSizeHeight']))) {
                            echo $result['trimSizeHeight'];
                        } ?>" required <?php if ((!empty($result['trimSizeHeight']))) {
                             echo 'readonly="readonly"';
                         } ?>>
                        <div class="text-danger" id="trimSizeHeightErr"></div>
                ...
                <div class="row">
                    <div class="col-md-6 mt-md-0 mt-3">
                        ...
                        <textarea class="form-control" name="visionDesign" id="visionDesign" rows="5" <?php if ((!empty($result['visionDesign'])))
                         {echo 'readonly="readonly"';} ?> data-toggle="tooltip"
                            data-placement="top"
                            title="The more information you provide, the better able we are to provide you with a cover projecting the image you wish to portray. And in the end, this will save you money. If we have a better idea what you want up front, we won't need to make changes later.">
                            <?php if ((!empty($result['visionDesign']))) {
