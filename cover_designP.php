        ...
        <div class="wrapper rounded bg-white">
            ...
            <form name="authorForm" onsubmit="return validateForm()"
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 mt-md-0 mt-3">
                        <label>Price to create barcode in dollars</label>
                ...
                <div class="row">
                    <div class="col-md-6 mt-md-0 mt-3">
                        ...
                        <textarea class="form-control" id="cfrontText" name="cfrontText" rows="4" value="<?php if ((!empty($result['bookCoverFront']))) {
                        ...
                        <textarea class="form-control" id="cbackText" name="cbackText" rows="4" value="<?php if ((!empty($result['bookCoverBack']))) {
                        ...
                        <textarea class="form-control" id="spineText" name="spineText" rows="4" readonly="readonly"
