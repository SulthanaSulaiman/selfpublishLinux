            ...
            <form name="authorForm" id="authorForm" action="#" method="post" enctype="multipart/form-data" class="form"
                ...
                <div class="row">
                    <div class="col-md-6 mt-md-0 mt-3">
                        ...
                        <label>Trim size width in inches<span class="text-danger">*</span><div style="display: inline-block;" data-toggle="tooltip" data-placement="top"
                                    title="Trim size width range is 5 to 11 in inches.">
                        ...
                        <input type="number" min="5" max="11" name="trimSizeWidth" id="trimSizeWidth" class="form-control" value="<?php if ((!empty($result['trimSizeWidth']))) {
                    ...
                    <div class="col-md-6 mt-md-0 mt-3">
                        <label>Trim size height in inches<span class="text-danger">*</span><div style="display: inline-block;" data-toggle="tooltip" data-placement="top"
                                    title="Trim size height range is 8 to 17 in inches.">
                                    <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="18" height="18"
                                        viewBox="0 0 512 512">
                                        <path fill="#25B7D3"
                                            d="M504.1,256C504.1,119,393,7.9,256,7.9C119,7.9,7.9,119,7.9,256C7.9,393,119,504.1,256,504.1C393,504.1,504.1,393,504.1,256z">
                        ...
                        <input type="number" min="8" max="17" name="trimSizeHeight" class="form-control" value="<?php if ((!empty($result['trimSizeHeight']))) {
        ...
        $(document).ready(function () {
            ...
            $('#authorForm').validate({
                ...
                messages: {
                    ...
                    trimSizeWidth: {
                        required: "Please enter the trim size width in inches.",
                    },
                    trimSizeHeight: {
                        required: "Please enter the trim size height in inches.",
                    },
                    paperWeight: {
