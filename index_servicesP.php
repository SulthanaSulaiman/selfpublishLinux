...
<body>
    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-lg-6">
                <h3 class="text-center p-2 " style="color:white; margin-top: 10px;">INDEX</h3>
            </div>
            ...
            <form name="authorForm" onsubmit="return validateForm()"
                ...
                <div class="row">
                    <div class="col-md-6 mt-md-0 mt-3">
                        ...
                        <textarea class="form-control" name="other" id="other" rows="5" readonly="other"
                        data-toggle="tooltip" data-placement="top"
                            title="Any other details that you like to include?"><?php if ((!empty($result['other']))) {
                                echo encodeValue($result['other']);
                            } ?></textarea>
                    ...
                    <div class="row">
                        <div class="col-md-12 mt-md-0 mt-3 text-center">
                            <button type="submit" class="btn btn-primary btn-lg" name="save" disabled="disabled">Export to Excel</button>
                        </div>
                    </div>
            </form>
        </div>
