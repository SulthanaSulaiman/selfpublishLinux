...
<head>
    ...
    <title>Production and Editorial</title>
...
<body>
    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-lg-6">
                <h3 class="text-center p-2 " style="color:white; margin-top: 10px;">PRODUCTION AND EDITORIAL</h3>
            </div>
            ...
            <form name="authorForm" onsubmit="return validateForm()"
                ...
                <div class="row">
                    <div class="col-md-6 mt-md-0 mt-3">
                        ...
                        <label>Your vision for your interior design.<!--<span class="text-danger">*</span>-->
                            ...
                            <textarea class="form-control" name="visonInteriorDesign" id="visonInteriorDesign" rows="2" readonly="readonly"
                ...
                <div class="row">
                        <div class="col-md-12 mt-md-0 mt-3 text-center">
                            <button type="submit" class="btn btn-primary btn-lg" name="export" disabled="diabled">Export to Excel</button>
                        </div>
                    </div>
            </form>
        </div>
