...
<body>
    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-lg-6">
                <h3 class="text-center p-2 heading  ">PRODUCTION, COVER, AND EDITORIAL</h3>
            </div>
            ...
            <form name="authorForm" onsubmit="return validateForm()"
                ...
                <div class="row">
                    <div class="col-md-6 mt-md-0 mt-3">
                        ...
                        <textarea class="form-control" id="spineText" name="spineText" rows="1" readonly="readonly"
                            ...
                            <textarea class="form-control" name="other" id="other" rows="4" readonly="readonly";
                             data-toggle="tooltip" data-placement="top"
