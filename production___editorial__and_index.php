...
function validateForm() {
 ...
 // Retrieving the values of form elements 
   ...
   var checkboxes = document.getElementsByName("requestedServices[]");
    ...
    var  trimSizeErr=fileErr=requestedServicesErr= true;
    ...
    if (requestedServices.length == 0) {
        printError("requestedServicesErr", "Please choose any one service.");
    } else {
        printError("requestedServicesErr", "");
        requestedServicesErr = false;
    }
 ...
 if ((trimSizeErr||fileErr||requestedServicesErr) == true) {
    console.log("trimSizeErr:"+trimSizeErr);
    console.log("fileErr:"+fileErr);
    console.log("fileErr:"+requestedServicesErr);
            ...
            <form name="authorForm" id="authorForm"
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 mt-md-0 mt-3">
                        ...
                        <div class="text-danger" id="requestedServicesErr"></div>
                ...
                <div class="row">
                    <div class="col-md-6 mt-md-0 mt-3">
                            ...
                            <textarea class="form-control" name="visonInteriorDesign" id="visonInteriorDesign" rows="5" <?php if ((!empty($result['visonInteriorDesign']))) {
                                echo 'readonly="readonly"';
